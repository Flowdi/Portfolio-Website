const translations = {
  de: {
    ...
    "footer.made": "Entwickelt mit Lust auf mehr.", "footer.top": "Nach oben ↑", "project.details": "Details ansehen", "project.progress": "In Entwicklung", "project.rebuild": "In Überarbeitung", "project.playable": "Spielbar", "project.planned": "Geplant", "project.complete": "Abgeschlossen"
  },
  en: {
    ...
    "footer.made": "Built with an appetite for more.", "footer.top": "Back to top ↑", "project.details": "View details", "project.progress": "In development", "project.rebuild": "Being rebuilt", "project.playable": "Playable", "project.planned": "Planned", "project.complete": "Completed"
  }
};
